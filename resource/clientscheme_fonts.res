Scheme
{
	...
	Fonts
	{
		...
		"G_FontHuge"
		{
			"1"
			{
				"name"			"LEMON MILK Bold" [$WINDOWS] // Primary font
				"name"			"LEMON MILK Bold" [!$WINDOWS] // Primary font
		...
		"G_FontHuge_2"
		{
			"1"
			{
				"name"			"N.O.- Movement" [$WINDOWS] // Secondary font
				"name"			"N.O.- Movement" [!$WINDOWS] // Secondary font
		...
		"G_FontHealth"
		{
			"1"
			{
				"name"			"LEMON MILK Bold" [$WINDOWS] // Health Font | Primary font
				"name"			"LEMON MILK Bold" [!$WINDOWS] // Health Font | Primary font
		...
		"G_FontAmmo"
		{
			"1"
			{
				"name"			"LEMON MILK Bold" [$WINDOWS] // Ammo Font | Primary font
				"name"			"LEMON MILK Bold" [!$WINDOWS] // Ammo Font | Primary font
		...
		"G_FontDamage"
		{
			"1"
			{
				"name"			"LEMON MILK" [$WINDOWS] // Damage font | Primary font
				"name"			"LEMON MILK" [!$WINDOWS] // Damage font | Primary font
				"tall"			"20" // Damage size
				"weight"		"0"
				"additive"		"0"
		...
		"G_FontCritDamage"
		{
			"1"
			{
				"name"			"LEMON MILK Bold" [$WINDOWS] // Crit damage font | Primary font
				"name"			"LEMON MILK Bold" [!$WINDOWS] // Crit damage font | Primary font
		...
		"G_FontTargetIDHealth"
		{
			"1"
			{
				"name"			"N.O.- Movement" [$WINDOWS] // Target ID health font | Primary font
				"name"			"N.O.- Movement" [!$WINDOWS] // Target ID health font | Primary font
				"tall"			"13" // Target ID health text size
				"weight"		"0"
				"additive"		"0"
				"antialias" 	"1"
			}
		...
		"G_FontKillfeed"
		{
			"1"
			{
				"name"		"N.O.- Movement" // Killfeed font
		...
		"CloseCaption_Normal"
		{
			"1"
			{
				"name"		"N.O.- Movement" [$WINDOWS] // Closed captions font | Secondary font
				"name"		"N.O.- Movement" [!$WINDOWS] // Closed captions font | Secondary font
		...
		"GlobalChatFont"
		{
			"1"
			{
				"name"			"N.O.- Movement" // Chat font
				"tall"			"N.O.- Movement" // Chat fontsize
